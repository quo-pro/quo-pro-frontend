...
export function QuoPostViewer(props: Props) {
    ...
    return (
        ...
        >
            <Editor
                readOnly
                className="bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-none focus-visible:outline-none border-none outline-none focus-within:ring-0 ring-0 h-full"
            />
        </Plate>
    );
}
